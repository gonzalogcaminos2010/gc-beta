                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('people.update', $person->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="dni" class="block mt-1 w-full" type="text" name="dni" :value="old('dni', $person->dni)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="cuil" class="block mt-1 w-full" type="text" name="cuil" :value="old('cuil', $person->cuil)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="employment_type" name="employment_type" class="block mt-1 w-full" required>
                                <option value="employee" {{ old('employment_type', $person->employment_type) == 'employee' ? 'selected' : '' }}>Empleado</option>
                                <option value="contractor" {{ old('employment_type', $person->employment_type) == 'contractor' ? 'selected' : '' }}>Contratista</option>
                            </select>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone', $person->phone)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="hire_date" class="block mt-1 w-full" type="date" name="hire_date" :value="old('hire_date', $person->hire_date)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address', $person->address)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city', $person->city)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="state" class="block mt-1 w-full" type="text" name="state" :value="old('state', $person->state)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="country" class="block mt-1 w-full" type="text" name="country" :value="old('country', $person->country)" />
                        ...
                        @if (Auth::user()->hasRole('admin'))
                            <div class="mt-4">
                                ...
                                <select id="approved" name="approved" class="block mt-1 w-full">
                                    <option value="0" {{ old('approved', $person->approved) == '0' ? 'selected' : '' }}>Inactivo</option>
                                    <option value="1" {{ old('approved', $person->approved) == '1' ? 'selected' : '' }}>Activo</option>
                                </select>
